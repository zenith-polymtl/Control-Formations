...
SEED          = 123     # RNG seed (change for a different “random” path)
...
FX_RANGE = (0.002, 0.003)
FY_RANGE = (0.001, 0.0017)
FZ_RANGE = (0.0015, 0.010)
...
class Ballon_publisher(Node):
    def __init__(self):
        ...
        self.ballon_pub = self.create_subscription(PoseStamped, '/Ballon_pose')
    ...
    def ballon_pub(self):
        ...
        self.x, self.y, self.z = build_soft_trajectory(time.time()-self.start_time)
